...
<div class="row">
  <div class="col-md-6">
    <form action="" method="get">
        ...
        <input type="search" class="form-control" placeholder="Serach student(s).." name="keyword" id="keyword" autofocus autocomplete="off" aria-label="Search student(s).." aria-describedby="button-addon2">
